...
static const ColorTable s_color_table[] = {
  ...
  { .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_BLACK, .short_name = "BK" },
  { .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_SILVER, .short_name = "SV" },
  { .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_GOLD, .short_name = "GD" },
#endif
};
