...
#elif PLATFORM_GETAFIX
  {
    .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_BLACK,
    .name = "BLACK",
    .short_name = "BK",
  },
  {
    .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_SILVER,
    .name = "SILVER",
    .short_name = "SV",
  },
  {
    .color = WATCH_INFO_COLOR_COREDEVICES_PTR2_GOLD,
    .name = "GOLD",
    .short_name = "GD",
  },
#endif
...
static void prv_get_display_colors(WatchInfoColor watch_color, GColor *color1, GColor *color2) {
  ...
  *color2 = GColorBlack;
  ...
  switch (watch_color) {
    ...
    // PTR2
    case WATCH_INFO_COLOR_COREDEVICES_PTR2_BLACK:
      *color1 = GColorBlack;
      *color2 = GColorBlack;
      break;
    case WATCH_INFO_COLOR_COREDEVICES_PTR2_SILVER:
      *color1 = GColorLightGray;  // Silver approximation
      *color2 = GColorLightGray;
      break;
    case WATCH_INFO_COLOR_COREDEVICES_PTR2_GOLD:
