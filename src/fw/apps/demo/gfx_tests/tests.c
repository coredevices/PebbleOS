...
static void prv_results_window_load(Window *window) {
  ...
  uint32_t per_frame = (100 * US_PER_FRAME) / avg_us;  // multiply by 100 to get decimals and
                                                       // account for x10 in avg_us calc
...
const PebbleProcessMd *gfx_tests_get_app_info() {
  static const PebbleProcessMdSystem gfx_tests_app_info = {
      ...
      .common = {
          ...
          .uuid = {
              0x06, 0xa8, 0x12, 0x6b, 0xd8, 0x05, 0x41, 0x97, 0xaf, 0x6d, 0x8d, 0xf3, 0xc1, 0xef,
              0xb8, 0xe4
          },
      }
  };
