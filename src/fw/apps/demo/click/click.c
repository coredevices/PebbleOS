...
static void prv_window_load(Window *window) {
  ...
  text_layer_set_text(
      text,
      "Use select button and try different clicks: single, hold-to-repeat, multiple, long press, "
      "etc.\n\nNOTE: a long click config will override hold-to-repeat config. Comment out the "
      "long_click section of the config to enable hold-to-repeat.");
...
const PebbleProcessMd *click_app_get_info() {
  static const PebbleProcessMdSystem s_click_app_info = {.common.main_func = s_main,
                                                         .name = "Clicks"};
