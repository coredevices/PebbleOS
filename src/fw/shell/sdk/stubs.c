      ...
      .common =
          {
              ...
              .uuid = {0x67, 0xa3, 0x2d, 0x95, 0xef, 0x69, 0x46, 0xd4, 0xa0, 0xb9, 0x85, 0x4c, 0xc6,
                       0x2f, 0x97, 0xf9},
          },
      .name = "Alarms",
  };
...
bool shell_prefs_get_stationary_enabled(void) { return false; }
...
bool timeline_peek_prefs_get_enabled(void) { return true; }
...
uint8_t activity_prefs_heart_get_resting_hr(void) { return 70; }

uint8_t activity_prefs_heart_get_elevated_hr(void) { return 100; }

uint8_t activity_prefs_heart_get_max_hr(void) { return 190; }
