...
#define FB_COLOR_FORMAT LCDC_PIXEL_FORMAT_RGB332//LCDC_PIXEL_FORMAT_RGB332
...
void display_init(void) {
  ...
  display_on();
  HAL_LCDC_LayerReset(&LCD_JDI_LPM015M135A->lcdc, HAL_LCDC_LAYER_DEFAULT); /*Set default layer configuration*/
  HAL_LCDC_LayerSetCmpr(&LCD_JDI_LPM015M135A->lcdc, HAL_LCDC_LAYER_DEFAULT, 0); /*Disable layer compress*/
  HAL_LCDC_LayerSetFormat(&LCD_JDI_LPM015M135A->lcdc, HAL_LCDC_LAYER_DEFAULT,
                          FB_COLOR_FORMAT); 
...
void display_clear(void) {
    ...
    display_write_multiple_pixles(&LCD_JDI_LPM015M135A->lcdc, (uint8_t *)s_framebuffer, 0, 0, FB_WIDTH - 1,
                                  FB_HEIGHT - 1);
