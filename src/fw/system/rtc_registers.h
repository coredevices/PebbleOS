...
#define CURRENT_TIME_REGISTER                   3
#define CURRENT_INTERVAL_TICKS_REGISTER         4
#define REBOOT_REASON_REGISTER_1                RTC_BACKUP_INITIALIZED
#define REBOOT_REASON_REGISTER_2                RTC_BAKCUP_OTA_FORCE_MODE
#define REBOOT_REASON_STUCK_TASK_PC             RTC_BAKCUP_WDT_STATUS
#define REBOOT_REASON_STUCK_TASK_LR             RTC_BACKUP_BT_TXPWR
#define REBOOT_REASON_STUCK_TASK_CALLBACK       RTC_BACKUP_NAND_OTA_DES
#define REBOOT_REASON_DROPPED_EVENT             RTC_BACKUP_MODULE_RECORD
