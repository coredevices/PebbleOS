...
bool gap_le_start_scan(void) { return true; }

bool gap_le_stop_scan(void) { return true; }

static bool s_gap_le_is_initialized = false;

void gap_le_init(uint32_t stack_id) { s_gap_le_is_initialized = true; }
...
bool fake_gap_le_is_initialized(void) { return s_gap_le_is_initialized; }
