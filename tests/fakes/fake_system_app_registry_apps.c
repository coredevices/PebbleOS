      ...
      .common =
          {
              ...
              .uuid =
                  {0x18, 0xe4, 0x43, 0xce, 0x38, 0xfd, 0x47, 0xc8, 0x84, 0xd5, 0x6d, 0x0c, 0x77,
                   0x5f, 0xbe, 0x55},
          },
      .name = "Watchfaces",
  };
      ...
      .common =
          {
              ...
              .uuid =
                  {0x67, 0xa3, 0x2d, 0x95, 0xef, 0x69, 0x46, 0xd4, 0xa0, 0xb9, 0x85, 0x4c, 0xc6,
                   0x2f, 0x97, 0xf9},
          },
      .name = "Alarms",
  };
      ...
      .common =
          {
              ...
              .uuid =
                  {0x22, 0x20, 0xd8, 0x05, 0xcf, 0x9a, 0x4e, 0x12, 0x92, 0xb9, 0x5c, 0xa7, 0x78,
                   0xaf, 0xf6, 0xbb},
...
const PebbleProcessMd *workout_app_get_info(void) {
  static const PebbleProcessMdSystem s_workout_app_info = {
      .common =
          {
              .uuid =
                  {0xfe, 0xf8, 0x2c, 0x82, 0x71, 0x76, 0x4e, 0x22, 0x88, 0xde, 0x35, 0xa3, 0xfc,
                   0x18, 0xd4, 0x3f},
          },
      .name = "Workout",
  };
