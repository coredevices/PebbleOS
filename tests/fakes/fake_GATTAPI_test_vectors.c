...
void fake_gatt_put_discovery_indication_health_thermometer_service(unsigned int connection_id) {
  GATT_Characteristic_Descriptor_Information_t cccd1 = {.Characteristic_Descriptor_Handle = 0x15,
  ...
  GATT_Service_Discovery_Indication_Data_t data = {
      .ConnectionID = connection_id,
      .ServiceInformation = {.Service_Handle = 0x11,
...
const Service *fake_gatt_get_health_thermometer_service(void) {
  s_health_thermometer_service =
      (const Service){.uuid = bt_uuid_expand_16bit(0x1809),
                      .handle = 0x11,
...
void fake_gatt_put_discovery_indication_blood_pressure_service(unsigned int connection_id) {
  GATT_Characteristic_Descriptor_Information_t cccd1 = {.Characteristic_Descriptor_Handle = 0x05,
                                                        .Characteristic_Descriptor_UUID = {
                                                            .UUID_Type = guUUID_16,
                                                            .UUID =
                                                                {
  ...
  GATT_Characteristic_Descriptor_Information_t cccd2 = {.Characteristic_Descriptor_Handle = 0x09,
                                                        .Characteristic_Descriptor_UUID = {
                                                            .UUID_Type = guUUID_16,
                                                            .UUID =
                                                                {
  ...
  GATT_Service_Information_t inc_service_list = {.Service_Handle = 0x11,
                                                 .End_Group_Handle = 0x15,
                                                 .UUID = {
                                                     .UUID_Type = guUUID_16,
                                                     .UUID =
  ...
  GATT_Service_Discovery_Indication_Data_t data = {
      .ConnectionID = connection_id,
      .ServiceInformation = {.Service_Handle = 0x1,
...
const Service *fake_gatt_get_blood_pressure_service(void) {
  s_blood_pressure_service =
      (const Service){.uuid = bt_uuid_expand_16bit(0x1810),
...
void fake_gatt_put_discovery_indication_random_128bit_uuid_service(unsigned int connection_id) {
  GATT_Characteristic_Descriptor_Information_t cccd1 = {
      ...
      .Characteristic_Descriptor_UUID = {
          ...
          .UUID =
              {
                  .UUID_128 = {0xB2, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63, 0x4F, 0xFA,
                               0x1B, 0x5B, 0x09, 0x68, 0xF7},
              },
      }};
  ...
  GATT_Characteristic_Descriptor_Information_t cccd2 = {
      ...
      .Characteristic_Descriptor_UUID = {
          ...
          .UUID =
              {
                  .UUID_128 = {0xB4, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63, 0x4F, 0xFA,
                               0x1B, 0x5B, 0x09, 0x68, 0xF7},
              },
      }};
              ...
              .UUID =
                  {
                      ...
                      .UUID =
                          {
                              .UUID_128 = {0xB0, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63,
                                           0x4F, 0xFA, 0x1B, 0x5B, 0x09, 0x68, 0xF7},
                          },
                  },
          },
      .NumberOfCharacteristics = 0x2,
