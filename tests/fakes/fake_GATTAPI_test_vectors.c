...
void fake_gatt_put_discovery_indication_random_128bit_uuid_service(unsigned int connection_id) {
  GATT_Characteristic_Descriptor_Information_t cccd1 = {
      ...
      .Characteristic_Descriptor_UUID = {
          ...
          .UUID = {
              .UUID_128 = {
                  0xB2, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63, 0x4F, 0xFA, 0x1B, 0x5B,
                  0x09, 0x68, 0xF7
              },
          },
      }
  ...
  GATT_Characteristic_Descriptor_Information_t cccd2 = {
      ...
      .Characteristic_Descriptor_UUID = {
          ...
          .UUID = {
              .UUID_128 = {
                  0xB4, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63, 0x4F, 0xFA, 0x1B, 0x5B,
                  0x09, 0x68, 0xF7
              },
          },
      }
              ...
              .UUID =
                  {
                      ...
                      .UUID =
                          {
                              .UUID_128 =
                                  {0xB0, 0xF9, 0x66, 0xAC, 0xED, 0xFD, 0xEE, 0x97, 0x63, 0x4F, 0xFA,
