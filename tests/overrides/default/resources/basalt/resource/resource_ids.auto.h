...
typedef enum {
  ...
  RESOURCE_ID_NOTIFICATION_BEEPER_TINY = 381,
  RESOURCE_ID_NOTIFICATION_BEEPER_SMALL = 382,
  RESOURCE_ID_NOTIFICATION_BEEPER_LARGE = 383,
  RESOURCE_ID_NOTIFICATION_BLUESKY_TINY = 384,
  RESOURCE_ID_NOTIFICATION_BLUESKY_SMALL = 385,
  RESOURCE_ID_NOTIFICATION_BLUESKY_LARGE = 386,
  RESOURCE_ID_NOTIFICATION_DISCORD_TINY = 387,
  RESOURCE_ID_NOTIFICATION_DISCORD_SMALL = 388,
  RESOURCE_ID_NOTIFICATION_DISCORD_LARGE = 389,
  RESOURCE_ID_NOTIFICATION_DUOLINGO_TINY = 390,
  RESOURCE_ID_NOTIFICATION_DUOLINGO_SMALL = 391,
  RESOURCE_ID_NOTIFICATION_DUOLINGO_LARGE = 392,
  RESOURCE_ID_NOTIFICATION_ELEMENT_TINY = 393,
  RESOURCE_ID_NOTIFICATION_ELEMENT_SMALL = 394,
  RESOURCE_ID_NOTIFICATION_ELEMENT_LARGE = 395,
  RESOURCE_ID_NOTIFICATION_GOOGLE_CHAT_TINY = 396,
  RESOURCE_ID_NOTIFICATION_GOOGLE_CHAT_SMALL = 397,
  RESOURCE_ID_NOTIFICATION_GOOGLE_CHAT_LARGE = 398,
  RESOURCE_ID_NOTIFICATION_GOOGLE_TASKS_TINY = 399,
  RESOURCE_ID_NOTIFICATION_GOOGLE_TASKS_SMALL = 400,
  RESOURCE_ID_NOTIFICATION_GOOGLE_TASKS_LARGE = 401,
  RESOURCE_ID_NOTIFICATION_HOME_ASSISTANT_TINY = 402,
  RESOURCE_ID_NOTIFICATION_HOME_ASSISTANT_SMALL = 403,
  RESOURCE_ID_NOTIFICATION_HOME_ASSISTANT_LARGE = 404,
  RESOURCE_ID_NOTIFICATION_STEAM_TINY = 405,
  RESOURCE_ID_NOTIFICATION_STEAM_SMALL = 406,
  RESOURCE_ID_NOTIFICATION_STEAM_LARGE = 407,
  RESOURCE_ID_NOTIFICATION_TEAMS_TINY = 408,
  RESOURCE_ID_NOTIFICATION_TEAMS_SMALL = 409,
  RESOURCE_ID_NOTIFICATION_TEAMS_LARGE = 410,
  RESOURCE_ID_NOTIFICATION_THREADS_TINY = 411,
  RESOURCE_ID_NOTIFICATION_THREADS_SMALL = 412,
  RESOURCE_ID_NOTIFICATION_THREADS_LARGE = 413,
  RESOURCE_ID_NOTIFICATION_UNIFI_PROTECT_TINY = 414,
  RESOURCE_ID_NOTIFICATION_UNIFI_PROTECT_SMALL = 415,
  RESOURCE_ID_NOTIFICATION_UNIFI_PROTECT_LARGE = 416,
  RESOURCE_ID_NOTIFICATION_ZOOM_TINY = 417,
  RESOURCE_ID_NOTIFICATION_ZOOM_SMALL = 418,
  RESOURCE_ID_NOTIFICATION_ZOOM_LARGE = 419,
  RESOURCE_ID_NOTIFICATION_EBAY_TINY = 420,
  RESOURCE_ID_NOTIFICATION_EBAY_SMALL = 421,
  RESOURCE_ID_NOTIFICATION_EBAY_LARGE = 422,
  RESOURCE_ID_NOTIFICATION_YOUTUBE_TINY = 423,
  RESOURCE_ID_NOTIFICATION_YOUTUBE_SMALL = 424,
  RESOURCE_ID_NOTIFICATION_YOUTUBE_LARGE = 425,
  ...
  RESOURCE_ID_NOTIFICATION_TWITCH_TINY = 429,
  RESOURCE_ID_NOTIFICATION_TWITCH_SMALL = 430,
  RESOURCE_ID_NOTIFICATION_TWITCH_LARGE = 431,
  RESOURCE_ID_SMART_ALARM_TINY = 432,
  RESOURCE_ID_HEALTH_APP_ACTIVITY = 433,
  RESOURCE_ID_HEALTH_APP_SLEEP = 434,
  RESOURCE_ID_HEALTH_APP_CROWN = 435,
  RESOURCE_ID_HEALTH_APP_HR = 436,
  RESOURCE_ID_HEALTH_APP_PULSING_HEART = 437,
  RESOURCE_ID_WORKOUT_APP_WALK = 438,
  RESOURCE_ID_WORKOUT_APP_WALK_SMALL = 439,
  RESOURCE_ID_WORKOUT_APP_WALK_TINY = 440,
  RESOURCE_ID_WORKOUT_APP_RUN = 441,
  RESOURCE_ID_WORKOUT_APP_RUN_SMALL = 442,
  RESOURCE_ID_WORKOUT_APP_RUN_TINY = 443,
  RESOURCE_ID_WORKOUT_APP_WORKOUT = 444,
  RESOURCE_ID_WORKOUT_APP_WORKOUT_SMALL = 445,
  RESOURCE_ID_WORKOUT_APP_DETECTED = 446,
  RESOURCE_ID_WORKOUT_APP_HEART = 447,
  RESOURCE_ID_WORKOUT_APP_MEASURING_HR = 448,
  RESOURCE_ID_WORKOUT_APP_HR_PULSE_TINY = 449,
  RESOURCE_ID_WORKOUT_APP_END = 450,
  RESOURCE_ID_WORKOUT_APP_ONE = 451,
  RESOURCE_ID_WORKOUT_APP_TWO = 452,
  RESOURCE_ID_WORKOUT_APP_THREE = 453,
  RESOURCE_ID_HEART_TINY = 454,
  RESOURCE_ID_HEART_SMALL = 455,
  RESOURCE_ID_HEART_LARGE = 456,
  RESOURCE_ID_BACKLIGHT = 457,
  RESOURCE_ID_AIRPLANE = 458,
  RESOURCE_ID_MODAL_CONTRACT_TO_MODAL_SEQUENCE = 459,
  RESOURCE_ID_MODAL_CONTRACT_FROM_MODAL_SEQUENCE = 460,
  RESOURCE_ID_MODAL_EXPAND_TO_APP_SEQUENCE = 461,
  RESOURCE_ID_NO_EVENTS_LARGE = 462,
  RESOURCE_ID_ALARM_CLOCK_LARGE = 463,
  RESOURCE_ID_BATTERY_ICON_CHARGING_LARGE = 464,
  RESOURCE_ID_RESULT_DELETED_LARGE = 465,
  RESOURCE_ID_RESULT_SHREDDED_LARGE = 466,
  RESOURCE_ID_RESULT_DISMISSED_LARGE = 467,
  RESOURCE_ID_GENERIC_CONFIRMATION_LARGE = 468,
  RESOURCE_ID_INCOMING_PHONE_CALL_LARGE = 469,
  RESOURCE_ID_RESULT_MUTE_LARGE = 470,
  RESOURCE_ID_RESULT_SENT_LARGE = 471,
  RESOURCE_ID_RESULT_UNMUTE_LARGE = 472,
  RESOURCE_ID_TIMER_APP_FACE_ICON = 473,
  RESOURCE_ID_STOPWATCH_APP_FACE_ICON = 474,
  RESOURCE_ID_ESPN_APP_FACE_ICON = 475,
  RESOURCE_ID_HEALTH_APP_FACE_ICON = 476,
  RESOURCE_ID_SEND_TEXT_APP_FACE_ICON = 477,
  RESOURCE_ID_QUIET_TIME_ACTIVE = 478,
  RESOURCE_ID_BATTERY_CHARGING_ICON = 479,
  RESOURCE_ID_HEALTH_ICON_MOON = 480,
  RESOURCE_ID_HEALTH_ICON_ROTATED_MOON = 481,
  RESOURCE_ID_SYSTEM_FCC_MARK = 482,
  RESOURCE_ID_SYSTEM_KCC_MARK = 483,
  RESOURCE_ID_SYSTEM_CE_MARK = 484,
  RESOURCE_ID_SYSTEM_WEEE_MARK = 485,
  RESOURCE_ID_SYSTEM_UKCA_MARK = 486,
  RESOURCE_ID_SYSTEM_R_MARK = 487,
  RESOURCE_ID_SYSTEM_T_MARK = 488,
  RESOURCE_ID_SYSTEM_AUS_RCM_MARK = 489,
  RESOURCE_ID_SYSTEM_NOM_NYCE_MARK = 490,
  RESOURCE_ID_WEATHER_CHANNEL_LOGO = 491,
  RESOURCE_ID_STRIDE_SHOE_GREEN = 492,
  RESOURCE_ID_STRIDE_SHOE_GREEN_SMALL = 493,
  RESOURCE_ID_STRIDE_SHOE_BLUE = 494,
  RESOURCE_ID_STRIDE_SHOE_BLUE_SMALL = 495,
  RESOURCE_ID_VIBE_SCORE_FLUTTER_PULSE = 496,
  RESOURCE_ID_VIBE_SCORE_REVEILLE = 497,
  RESOURCE_ID_VIBE_SCORE_HAPTIC_FEEDBACK = 498,
  RESOURCE_ID_VIBE_SCORE_NUDGE_NUDGE = 499,
  RESOURCE_ID_VIBE_SCORE_PULSE = 500,
  RESOURCE_ID_VIBE_SCORE_JACKHAMMER = 501,
  RESOURCE_ID_VIBE_SCORE_MARIO = 502,
  RESOURCE_ID_VIBE_SCORE_STANDARD_SHORT_LOW = 503,
  RESOURCE_ID_VIBE_SCORE_STANDARD_SHORT_HIGH = 504,
  RESOURCE_ID_VIBE_SCORE_STANDARD_LONG_LOW = 505,
  RESOURCE_ID_VIBE_SCORE_STANDARD_LONG_HIGH = 506,
  RESOURCE_ID_VIBE_SCORE_ALARM_LPM = 507,
  ...
  RESOURCE_ID_SMART_ALARM_ICON_BLACK = 520,
  RESOURCE_ID_MENU_ICON_HEALTH = 521,
  RESOURCE_ID_AGENCY_FB_36_NUMBERS_AM_PM = 522,
  RESOURCE_ID_AGENCY_FB_60_NUMBERS_AM_PM = 523,
  RESOURCE_ID_AGENCY_FB_60_THIN_NUMBERS_AM_PM = 524,
  RESOURCE_ID_STORED_APP_GOLF = 525,
  RESOURCE_ID_BT_PATCH = 526,
  RESOURCE_ID_TIMEZONE_DATABASE = 527,
  RESOURCE_ID_ACTION_BAR_ICON_CHECK = 528,
  RESOURCE_ID_GENERIC_WARNING_LARGE = 529,
  RESOURCE_ID_FONT_FALLBACK_INTERNAL = 530,
  RESOURCE_ID_ACTION_BAR_ICON_UP = 531,
  RESOURCE_ID_ACTION_BAR_ICON_DOWN = 532,
  RESOURCE_ID_GENERIC_WARNING_TINY = 533,
  RESOURCE_ID_CHECK_INTERNET_CONNECTION_LARGE = 534,
  RESOURCE_ID_WATCH_DISCONNECTED_LARGE = 535,
  RESOURCE_ID_ARROW_DOWN = 536,
  RESOURCE_ID_VOICE_MICROPHONE_LARGE = 537,
  RESOURCE_ID_JS_TICTOC = 538,
  RESOURCE_ID_PUG = 539,
  RESOURCE_ID_STRINGS = 540,
  RESOURCE_ID_GOTHIC_14_EXTENDED = 541,
  RESOURCE_ID_GOTHIC_14_BOLD_EXTENDED = 542,
  RESOURCE_ID_GOTHIC_18_EXTENDED = 543,
  RESOURCE_ID_GOTHIC_18_BOLD_EXTENDED = 544,
  RESOURCE_ID_GOTHIC_24_EXTENDED = 545,
  RESOURCE_ID_GOTHIC_24_BOLD_EXTENDED = 546,
  RESOURCE_ID_GOTHIC_28_EXTENDED = 547,
  RESOURCE_ID_GOTHIC_28_BOLD_EXTENDED = 548,
  RESOURCE_ID_BITHAM_18_LIGHT_SUBSET_EXTENDED = 549,
  RESOURCE_ID_BITHAM_30_BLACK_EXTENDED = 550,
  RESOURCE_ID_BITHAM_34_LIGHT_SUBSET_EXTENDED = 551,
  RESOURCE_ID_BITHAM_34_MEDIUM_NUMBERS_EXTENDED = 552,
  RESOURCE_ID_BITHAM_42_BOLD_EXTENDED = 553,
  RESOURCE_ID_BITHAM_42_LIGHT_EXTENDED = 554,
  RESOURCE_ID_BITHAM_42_MEDIUM_NUMBERS_EXTENDED = 555,
  RESOURCE_ID_ROBOTO_CONDENSED_21_EXTENDED = 556,
  RESOURCE_ID_ROBOTO_BOLD_SUBSET_49_EXTENDED = 557,
  RESOURCE_ID_DROID_SERIF_28_BOLD_EXTENDED = 558,
