...
KinoLayer *kino_layer_create(GRect frame) { return NULL; }

void kino_layer_destroy(KinoLayer *kino_layer) {}

Layer *kino_layer_get_layer(KinoLayer *kino_layer) { return NULL; }
...
KinoReel *kino_layer_get_reel(KinoLayer *kino_layer) { return NULL; }

KinoPlayer *kino_layer_get_player(KinoLayer *kino_layer) { return NULL; }

GColor kino_layer_get_background_color(KinoLayer *kino_layer) { return GColorClear; }

GAlign kino_layer_get_alignment(KinoLayer *kino_layer) { return 0; }
...
GRect kino_layer_get_reel_bounds(KinoLayer *kino_layer) { return (GRect){}; }
