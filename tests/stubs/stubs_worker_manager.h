...
const PebbleProcessMd *worker_manager_get_current_worker_md(void) { return NULL; }
...
AppInstallId worker_manager_get_default_install_id(void) { return 0; }

AppInstallId worker_manager_get_current_worker_id(void) { return 0; }

AppInstallId sys_worker_manager_get_current_worker_id(void) { return 0; }
