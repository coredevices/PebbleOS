...
ResAppNum WEAK sys_get_current_resource_num(void) { return 0; }
...
bool WEAK sys_resource_bytes_are_readonly(void *bytes) { return false; }
...
void WEAK sys_font_reload_font(FontInfo *fontinfo) { return; }

GFont WEAK sys_font_get_system_font(const char *key) { return NULL; }

bool WEAK sys_accel_manager_data_unsubscribe(AccelManagerState *state) { return false; }

AppInstallId WEAK sys_process_manager_get_current_process_id(void) { return (AppInstallId)(-1); }
