...
PascalString16 *pstring_create_pstring16(uint16_t size) { return NULL; }

PascalString16 *pstring_create_pstring16_from_string(char string[]) { return NULL; }
...
bool pstring_equal(const PascalString16 *ps1, const PascalString16 *ps2) { return false; }

bool pstring_equal_cstring(const PascalString16 *pstr, const char *cstr) { return false; }

SerializedArray *pstring_create_serialized_array(uint16_t data_size) { return NULL; }
...
uint16_t pstring_get_number_of_pstring16s_in_list(PascalString16List *pstring16_list) { return 0; }
