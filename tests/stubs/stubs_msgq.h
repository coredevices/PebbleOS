...
int pbl_msgq_put_front(struct pbl_msgq *q, const void *msg, pbl_timeout_t timeout) { return 0; }

int pbl_msgq_get(struct pbl_msgq *q, void *msg, pbl_timeout_t timeout) { return 0; }

int pbl_msgq_peek(struct pbl_msgq *q, void *msg) { return 0; }

void pbl_msgq_purge(struct pbl_msgq *q) {}

uint32_t pbl_msgq_num_used(const struct pbl_msgq *q) { return 0; }

uint32_t pbl_msgq_num_free(const struct pbl_msgq *q) { return q->max_msgs; }
...
bool pbl_poll_group_is_empty(const struct pbl_poll_group *g) { return true; }
