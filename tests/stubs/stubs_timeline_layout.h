...
LayoutLayer *WEAK calendar_layout_create(const LayoutLayerConfig *config) { return NULL; }

bool WEAK calendar_layout_verify(bool existing_attributes[]) { return false; }

LayoutLayer *WEAK generic_layout_create(const LayoutLayerConfig *config) { return NULL; }

bool WEAK generic_layout_verify(bool existing_attributes[]) { return false; }

LayoutLayer *WEAK health_layout_create(const LayoutLayerConfig *config) { return NULL; }

bool WEAK health_layout_verify(bool existing_attributes[]) { return false; }

LayoutLayer *WEAK notification_layout_create(const LayoutLayerConfig *config) { return NULL; }

bool WEAK notification_layout_verify(bool existing_attributes[]) { return false; }
