...
bool WEAK evented_timer_reschedule(EventedTimerID timer, uint32_t new_timeout_ms) { return true; }
...
bool WEAK evented_timer_exists(EventedTimerID timer) { return true; }

bool WEAK evented_timer_is_current_task(EventedTimerID timer) { return true; }
