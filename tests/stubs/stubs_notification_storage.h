...
bool WEAK notification_storage_notification_exists(const Uuid *id) { return false; }

size_t WEAK notification_storage_get_len(const Uuid *uuid) { return 0; }

bool WEAK notification_storage_get(const Uuid *id, TimelineItem *item_out) { return false; }

void WEAK notification_storage_set_status(const Uuid *id, uint8_t status) {}

bool WEAK notification_storage_get_status(const Uuid *id, uint8_t *status) { return false; }
