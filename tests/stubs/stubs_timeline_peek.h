...
unsigned int WEAK timeline_peek_get_concurrent_height(unsigned int num_concurrent) { return 0; }

int16_t WEAK timeline_peek_get_origin_y(void) { return DISP_ROWS; }

int16_t WEAK timeline_peek_get_obstruction_origin_y(void) { return DISP_ROWS; }
...
bool WEAK timeline_peek_prefs_get_enabled() { return true; }
