...
void ios_notif_pref_db_init(void) { return; }
...
int ios_notif_pref_db_get_len(const uint8_t *key, int key_len) { return 1; }
...
status_t ios_notif_pref_db_delete(const uint8_t *key, int key_len) { return S_SUCCESS; }

status_t ios_notif_pref_db_flush(void) { return S_SUCCESS; }
...
BlobDBDirtyItem *ios_notif_pref_db_get_dirty_list(void) { return NULL; }

status_t ios_notif_pref_db_mark_synced(const uint8_t *key, int key_len) { return S_SUCCESS; }

status_t ios_notif_pref_db_compact(void) { return S_SUCCESS; }
