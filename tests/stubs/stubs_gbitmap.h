...
GBitmapFormat gbitmap_get_format(const GBitmap *bitmap) { return bitmap->info.format; }
...
uint16_t gbitmap_format_get_row_size_bytes(int16_t width, GBitmapFormat format) { return width; }

GRect gbitmap_get_bounds(const GBitmap *bitmap) { return bitmap->bounds; }
