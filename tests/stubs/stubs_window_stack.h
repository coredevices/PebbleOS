...
bool window_stack_is_animating_with_fixed_status_bar(WindowStack *window_stack) { return false; }

bool window_stack_contains_window(WindowStack *window_stack, Window *window) { return false; }

bool window_transition_context_has_legacy_window_to(WindowStack *stack, Window *window) {
  return false;
}

bool app_window_stack_remove(Window *window, bool animated) { return false; }
