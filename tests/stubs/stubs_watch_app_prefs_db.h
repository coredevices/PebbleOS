...
int watch_app_prefs_db_get_len(const uint8_t *key, int key_len) { return 0; }
...
status_t watch_app_prefs_db_delete(const uint8_t *key, int key_len) { return S_SUCCESS; }

status_t watch_app_prefs_db_flush(void) { return S_SUCCESS; }

status_t watch_app_prefs_db_compact(void) { return S_SUCCESS; }
