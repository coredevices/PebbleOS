...
bool WEAK timeline_item_action_is_ancs(const TimelineItemAction *action) { return false; }

bool WEAK timeline_item_action_is_dismiss(const TimelineItemAction *action) { return false; }

TimelineItemAction *WEAK timeline_item_find_dismiss_action(const TimelineItem *item) {
  return NULL;
}

bool WEAK timeline_item_is_ancs_notif(const TimelineItem *item) { return false; }
